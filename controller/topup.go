...
func GetTopUpInfo(c *gin.Context) {
	...
	data := gin.H{
		...
		"inviter_top_up_reward_ratio": common.InviterTopUpRewardRatio,
	}
...
func EpayNotify(c *gin.Context) {
	...
	if verifyInfo.TradeStatus == epay.StatusTradeSuccess {
		...
		if topUp.Status == common.TopUpStatusPending {
			...
			model.RecordTopupLog(topUp.UserId, fmt.Sprintf("Online top-up succeeded, quota: %v, payment amount: %f", logger.FormatQuota(quotaToAdd), topUp.Money), c.ClientIP(), topUp.PaymentMethod, "epay")
		}
	} else {
