...
const quotaSchema = z.object({
  ...
  InviterTopUpRewardRatio: z.coerce.number().min(0).max(1),
  TopUpLink: z.string(),
      ...
      <Form {...form}>
        <SettingsForm onSubmit={handleSubmit}>
          ...
          <SettingsFormGrid>
            ...
            <FormField
              control={form.control}
              name='InviterTopUpRewardRatio'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Inviter Top-Up Reward Ratio')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={0}
                  ...
                  <FormDescription>
                    {t(
                      'Fraction of each Stripe top-up payment credited to the inviter (0.05 = 5%)'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
